...
export const id: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Worker cloud memerlukan runtime OpenClaw; {runtime} yang dipilih.",
  ...
  sessionsView: {
    ...
    sessionsArchived: "{count} sesi diarsipkan",
    deleteAllArchived: "Hapus semua arsip…",
    deleteAllArchivedConfirm: "Hapus {count} sesi terarsip beserta transkripnya?",
  ...
  subtitles: {
    ...
    security: "Autentikasi Gateway, kebijakan exec, profil tool, dan persetujuan.",
    advanced: "Semua bagian konfigurasi yang tersisa, ditambah editor file mentah.",
  ...
  appsPage: {
    ...
    badgeBundledIos: "Termasuk dalam aplikasi iOS",
    ...
    cards: {
      ...
      chrome: {
        ...
        desc: "Biarkan OpenClaw mengendalikan Chrome Anda yang ada — tab, halaman, dan formulir.",
      },
      plugins: {
        title: "Plugin & ClawHub",
        desc: "Perluas OpenClaw dengan channel, tool, dan skill dari komunitas.",
      },
    },
  },
  profilePage: {
  ...
  chat: {
    ...
    modelControls: {
      ...
      usingDefault: "Menggunakan default dari Setelan",
