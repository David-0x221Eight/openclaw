...
export const ja_JP: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "クラウドワーカーには OpenClaw ランタイムが必要です。現在 {runtime} が選択されています。",
  ...
  sessionsView: {
    ...
    sessionsArchived: "{count} 件のセッションをアーカイブしました",
    deleteAllArchived: "アーカイブをすべて削除…",
    deleteAllArchivedConfirm:
      "{count} 件のアーカイブ済みセッションとそのトランスクリプトを削除しますか？",
  ...
  configView: {
    ...
    syncedHint: "Gateway を通じてお使いのデバイス間で同期されます。",
    notifications: {
      title: "プッシュ通知",
  ...
  subtitles: {
    ...
    apps: "スマートフォン、時計、デスクトップ、ブラウザ向けのコンパニオンアプリ。",
    ...
    notifications: "Gateway からのブラウザプッシュ通知。",
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "システムのセットアップガイド",
    exitSetup: "セットアップを終了",
    hatchDraft: "起きて、私の友よ！",
    placeholder: "OpenClaw にメッセージを送信…",
    ...
    unsupportedGateway: "OpenClaw のセットアップを続行するには Gateway を更新してください。",
  },
  mcpServers: {
    add: "サーバーを追加",
    adding: "追加中…",
    ...
    targetInvalid: "http(s) の URL またはコマンドラインを入力してください。",
    nameTaken: "「{name}」という名前の MCP サーバーは既に存在します。",
    missing: "MCP サーバー「{name}」が構成内に見つかりませんでした。",
    ...
    configUnavailable: "構成を利用できません。再読み込みしてやり直してください。",
  ...
  mcpPage: {
    connectorsLink: "Plugins ページでワンクリックコネクタを見つけましょう。",
    servers: "サーバー",
    oauth: "OAuth",
    filtered: "フィルター済み",
  ...
  appsPage: {
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Androidスマートフォンを完全なOpenClawノードとして — チャット、カメラ、Canvas。",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "手首で一目でわかるチャットとクイック返信。",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Android コンパニオンが OpenClaw をあなたの腕時計に拡張します。",
      },
      macos: {
        title: "macOS",
        desc: "Gateway 用のメニューバーコンパニオン — 通知、承認、クイックチャット。",
      },
      windows: {
        title: "Windows",
        desc: "Windows コンパニオンが PC を OpenClaw ノードとして接続します。",
      },
      linux: {
        title: "Linux",
        desc: "ネイティブデスクトップアプリ — .deb および AppImage ビルド。",
      },
      chrome: {
        title: "Chrome 拡張機能",
        desc: "OpenClaw に既存の Chrome を操作させましょう — タブ、ページ、フォーム。",
      },
      plugins: {
  ...
  chat: {
    ...
    questions: {
      ...
      timeRemaining: "残り時間",
      ownAnswer: "自分で回答を入力…",
      ownAnswerFor: "{header} の自分の回答",
      submitting: "送信中…",
      submitFailed: "送信できませんでした: {error}",
      answered: "応答あり",
      answeredElsewhere: "他の場所で回答済み",
      expired: "期限切れ",
      cancelled: "キャンセル済み",
    },
    messages: {
