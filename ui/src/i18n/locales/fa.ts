...
export const fa: TranslationMap = {
  ...
  sessionsView: {
    ...
    global: "سراسری",
    unknown: "نامشخص",
    sessionState: "وضعیت نشست",
    viewArchived: "مشاهده بایگانی‌شده‌ها",
    sessionArchived: "نشست بایگانی شد",
    sessionsArchived: "{count} نشست بایگانی شد",
    deleteAllArchived: "حذف همه بایگانی‌شده‌ها…",
    deleteAllArchivedConfirm: "{count} نشست بایگانی‌شده و رونوشت‌های آن‌ها حذف شوند؟",
  ...
  configView: {
    ...
    syncedHint: "از طریق gateway در دستگاه‌های شما همگام‌سازی می‌شود.",
    notifications: {
  ...
  subtitles: {
    ...
    notifications: "اعلان‌های فشاری مرورگر از gateway شما.",
    security: "احراز هویت Gateway، سیاست exec، نمایه ابزار و تأییدها.",
    advanced: "همه بخش‌های پیکربندی باقی‌مانده، به‌علاوه ویرایشگر فایل خام.",
  ...
  mcpServers: {
    ...
    nameTaken: "سرور MCP با نام «{name}» از قبل وجود دارد.",
  ...
  mcpPage: {
    connectorsLink: "رابط‌های یک‌کلیکی را در صفحه Plugins کشف کنید.",
    servers: "سرورها",
    oauth: "OAuth",
    filtered: "فیلترشده",
  ...
  sessionsPage: {
    hubTablistLabel: "بخش‌های نشست‌ها",
  },
  pluginsPage: {
  ...
  appsPage: {
    ...
    heroTagline:
      "برنامه‌های همراه برای تلفن، ساعت، دسکتاپ و مرورگر شما — به‌همراه افزونه‌هایی برای گسترش قابلیت‌های عامل شما.",
    sectionMobile: "روی تلفن شما",
    sectionWatch: "روی مچ شما",
    sectionDesktop: "روی دسکتاپ شما",
    sectionBrowser: "در مرورگر شما",
    sectionCommunity: "انجمن",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "گفتگو، صحبت، تأیید اقدامات و اشتراک‌گذاری در OpenClaw از iOS.",
      },
      android: {
        title: "Android",
        desc: "تلفن Android شما به‌عنوان یک گره کامل OpenClaw — گفتگو، دوربین و Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "گفتگوهای قابل مشاهده در یک نگاه و پاسخ‌های سریع از مچ شما.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "همراه اندروید، OpenClaw را به ساعت شما گسترش می‌دهد.",
      },
      macos: {
        title: "macOS",
        desc: "همراه نوار منو برای Gateway شما — اعلان‌ها، تأییدها، گفتگوی سریع.",
      },
      windows: {
        title: "Windows",
      ...
      chrome: {
        title: "افزونه Chrome",
        desc: "به OpenClaw اجازه دهید Chrome موجود شما را هدایت کند — برگه‌ها، صفحه‌ها و فرم‌ها.",
      },
      plugins: {
  ...
  chat: {
    ...
    questions: {
      ...
      ownAnswer: "پاسخ شما…",
      ownAnswerFor: "پاسخ شما برای {header}",
      submitting: "در حال ارسال…",
      submitFailed: "ارسال ممکن نشد: {error}",
      answered: "پاسخ داده شد",
      answeredElsewhere: "در جای دیگری پاسخ داده شد",
      expired: "منقضی‌شده",
      cancelled: "لغوشده",
    },
    messages: {
