...
export const nl: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionArchived: "Sessie gearchiveerd",
    sessionsArchived: "{count} sessies gearchiveerd",
    deleteAllArchived: "Alle gearchiveerde verwijderen…",
    deleteAllArchivedConfirm: "{count} gearchiveerde sessies en hun transcripties verwijderen?",
  ...
  nav: {
    ...
    askOpenClaw: "Vraag het OpenClaw",
  ...
  subtitles: {
    ...
    apps: "Bijbehorende apps voor telefoon, horloge, desktop en browser.",
    ...
    advanced: "Elke overige configuratiesectie, plus de ruwe bestandseditor.",
  ...
  custodian: {
    ...
    exitSetup: "Installatie verlaten",
  ...
  mcpPage: {
    connectorsLink: "Ontdek één-klik-connectors op de pagina Plugins.",
    servers: "Servers",
    oauth: "OAuth",
    filtered: "Gefilterd",
  ...
  appsPage: {
    ...
    heroTagline:
      "Begeleidende apps voor je telefoon, horloge, desktop en browser — plus plugins om uit te breiden wat je agent kan doen.",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Je Android-telefoon als een volledige OpenClaw-node — chat, camera en Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
  ...
  chat: {
    ...
    questions: {
      ...
      submitFailed: "Kan niet verzenden: {error}",
      answered: "Beantwoord",
    ...
    modelControls: {
      ...
      reasoning: "Redenering",
      speed: "Snelheid",
      sessionOverride: "Sessie-override",
      usingDefault: "Standaardinstelling uit Instellingen wordt gebruikt",
