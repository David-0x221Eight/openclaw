...
export const tr: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionArchived: "Oturum arşivlendi",
    sessionsArchived: "{count} oturum arşivlendi",
    deleteAllArchived: "Arşivlenenlerin tümünü sil…",
    deleteAllArchivedConfirm: "{count} arşivlenmiş oturum ve dökümleri silinsin mi?",
  ...
  subtitles: {
    ...
    security: "Gateway kimlik doğrulama, yürütme politikası, araç profili ve onaylar.",
  ...
  mcpServers: {
    ...
    nameInvalid: "Sunucu adlarında harf, rakam, nokta, tire veya alt çizgi kullanılır.",
    targetInvalid: "Bir http(s) URL'si veya komut satırı girin.",
    nameTaken: "“{name}” adlı bir MCP sunucusu zaten var.",
    missing: "Yapılandırmada “{name}” adlı MCP sunucusu bulunamadı.",
  ...
  mcpPage: {
    connectorsLink: "Tek tıklamayla kullanılan bağlayıcıları Plugins sayfasında keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  sessionsPage: {
    hubTablistLabel: "Oturumlar bölümleri",
  },
  pluginsPage: {
  ...
  appsPage: {
    ...
    heroTagline:
      "Telefonunuz, saatiniz, masaüstünüz ve tarayıcınız için yardımcı uygulamalar — ayrıca aracınızın yapabileceklerini genişletecek eklentiler.",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Bileğinizden bir bakışta sohbetler ve hızlı yanıtlar.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Android eşlik uygulaması OpenClaw'ı saatinize taşır.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "Windows eşlik uygulaması bilgisayarınızı bir OpenClaw düğümü olarak bağlar.",
      },
      linux: {
        title: "Linux",
      ...
      plugins: {
        ...
        desc: "OpenClaw'ı topluluktan gelen kanallar, araçlar ve Skills ile genişletin.",
      },
    },
  },
  profilePage: {
