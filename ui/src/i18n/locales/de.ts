...
export const de: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionsArchived: "{count} Sitzungen archiviert",
    deleteAllArchived: "Alle archivierten löschen…",
    deleteAllArchivedConfirm: "{count} archivierte Sitzungen und ihre Transkripte löschen?",
  ...
  configView: {
    ...
    syncedHint: "Über das Gateway auf allen Geräten synchronisiert.",
    notifications: {
  ...
  subtitles: {
    ...
    advanced: "Alle verbleibenden Konfigurationsbereiche sowie der Rohdatei-Editor.",
  ...
  mcpServers: {
    ...
    targetInvalid: "Geben Sie eine http(s)-URL oder eine Befehlszeile ein.",
    nameTaken: "Ein MCP-Server namens „{name}“ existiert bereits.",
    ...
    configUnavailable:
      "Die Konfiguration ist nicht verfügbar; aktualisieren Sie und versuchen Sie es erneut.",
  ...
  mcpPage: {
    connectorsLink: "Entdecken Sie Ein-Klick-Connectors auf der Plugins-Seite.",
    servers: "Server",
    oauth: "OAuth",
    filtered: "Gefiltert",
  ...
  sessionsPage: {
    hubTablistLabel: "Sitzungsbereiche",
  },
  pluginsPage: {
  ...
  appsPage: {
    heroTitle: "OpenClaw überall nutzen",
    heroTagline:
      "Begleit-Apps für Handy, Uhr, Desktop und Browser – dazu Plugins, um die Möglichkeiten deines Agents zu erweitern.",
    sectionMobile: "Auf deinem Handy",
    sectionWatch: "An deinem Handgelenk",
    sectionDesktop: "Auf deinem Desktop",
    sectionBrowser: "In deinem Browser",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chatte, sprich, genehmige Aktionen und teile Inhalte von iOS in OpenClaw.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Chats auf einen Blick und Schnellantworten direkt von deinem Handgelenk.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Menüleisten-Begleiter für dein Gateway — Benachrichtigungen, Freigaben, Schnellchat.",
      },
      windows: {
        title: "Windows",
      ...
      chrome: {
        ...
        desc: "Lass OpenClaw dein vorhandenes Chrome steuern — Tabs, Seiten und Formulare.",
      },
      plugins: {
        title: "Plugins & ClawHub",
        desc: "Erweitere OpenClaw mit Kanälen, Tools und Skills aus der Community.",
      },
    },
  },
  profilePage: {
  ...
  chat: {
    ...
    modelControls: {
      ...
      sessionOverride: "Sitzungsüberschreibung",
