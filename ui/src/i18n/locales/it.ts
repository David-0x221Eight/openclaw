...
export const it: TranslationMap = {
  ...
  sessionsView: {
    ...
    viewArchived: "Mostra archiviate",
    sessionArchived: "Sessione archiviata",
    sessionsArchived: "Archiviate {count} sessioni",
    deleteAllArchived: "Elimina tutte le archiviate…",
    deleteAllArchivedConfirm: "Eliminare {count} sessioni archiviate e le loro trascrizioni?",
  ...
  subtitles: {
    ...
    custodian: "Configurazione e cura del sistema.",
    ...
    advanced: "Tutte le restanti sezioni di configurazione, più l'editor del file grezzo.",
  ...
  custodian: {
    ...
    sensitivePlaceholder: "Inserisci il valore sensibile…",
  ...
  mcpServers: {
    ...
    targetInvalid: "Inserisci un URL http(s) o una riga di comando.",
    nameTaken: "Esiste già un server MCP denominato “{name}”.",
    missing: "Server MCP “{name}” non trovato nella configurazione.",
  ...
  sessionsPage: {
    hubTablistLabel: "Sezioni sessioni",
  },
  pluginsPage: {
  ...
  appsPage: {
    ...
    sectionMobile: "Sul telefono",
    sectionWatch: "Al polso",
    sectionDesktop: "Sul desktop",
    sectionBrowser: "Nel browser",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chatta, parla, approva azioni e condividi su OpenClaw da iOS.",
      },
      android: {
        title: "Android",
      ...
      windows: {
        title: "Windows",
        desc: "Il companion Windows collega il tuo PC come nodo OpenClaw.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Lascia che OpenClaw guidi il tuo Chrome esistente — schede, pagine e moduli.",
      },
      plugins: {
  ...
  chat: {
    ...
    modelControls: {
      ...
      reasoning: "Ragionamento",
      speed: "Velocità",
      sessionOverride: "Override sessione",
      usingDefault: "Utilizzo del valore predefinito da Impostazioni",
    ...
    composer: {
      ...
      turnCameraOff: "Disattiva fotocamera",
      turnCameraOn: "Attiva fotocamera",
