...
export const vi: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Worker đám mây yêu cầu runtime OpenClaw; {runtime} đang được chọn.",
  ...
  sessionsView: {
    ...
    sessionArchived: "Đã lưu trữ phiên",
    sessionsArchived: "Đã lưu trữ {count} phiên",
    deleteAllArchived: "Xóa tất cả đã lưu trữ…",
    deleteAllArchivedConfirm: "Xóa {count} phiên đã lưu trữ và bản ghi của chúng?",
  ...
  configView: {
    ...
    syncedHint: "Được đồng bộ trên các thiết bị của bạn qua gateway.",
    notifications: {
      title: "Thông báo đẩy",
  ...
  subtitles: {
    ...
    advanced: "Mọi phần cấu hình còn lại, cùng trình chỉnh sửa tệp thô.",
  ...
  custodian: {
    ...
    hatchDraft: "Thức dậy nào, người bạn của tôi!",
  ...
  mcpServers: {
    ...
    nameInvalid: "Tên máy chủ dùng chữ cái, chữ số, dấu chấm, gạch ngang hoặc gạch dưới.",
    targetInvalid: "Nhập URL http(s) hoặc dòng lệnh.",
    nameTaken: "Đã tồn tại máy chủ MCP tên “{name}”.",
    ...
    configUnavailable: "Không có cấu hình; hãy làm mới và thử lại.",
    connectRequired: "Kết nối với gateway để thay đổi máy chủ MCP.",
    adminRequired: "Việc thay đổi máy chủ MCP yêu cầu quyền operator.admin.",
    enable: "Bật",
    disable: "Tắt",
  ...
  appsPage: {
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Xem nhanh cuộc trò chuyện và trả lời tức thì ngay trên cổ tay.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Ứng dụng đồng hành Android mở rộng OpenClaw tới đồng hồ của bạn.",
      },
      macos: {
        title: "macOS",
        desc: "Ứng dụng đồng hành trên thanh menu cho Gateway — thông báo, phê duyệt, trò chuyện nhanh.",
      },
      windows: {
        title: "Windows",
        desc: "Ứng dụng đồng hành Windows kết nối máy tính của bạn như một node OpenClaw.",
      },
      linux: {
        title: "Linux",
