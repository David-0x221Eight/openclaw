...
export const zh_CN: TranslationMap = {
  ...
  configView: {
    ...
    syncedHint: "通过 gateway 在你的设备间同步。",
    notifications: {
      title: "推送通知",
  ...
  subtitles: {
    ...
    security: "Gateway 认证、执行策略、工具配置文件和审批。",
  ...
  mcpServers: {
    ...
    targetInvalid: "请输入 http(s) URL 或命令行。",
  ...
  appsPage: {
    ...
    heroTagline: "适用于手机、手表、桌面和浏览器的配套应用——还有可扩展智能体功能的插件。",
    sectionMobile: "在您的手机上",
    sectionWatch: "在您的手腕上",
    sectionDesktop: "在您的桌面上",
    sectionBrowser: "在您的浏览器中",
    sectionCommunity: "社区",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "在 iOS 上聊天、语音、批准操作，并将内容分享到 OpenClaw。",
      },
      android: {
        title: "Android",
      ...
      macos: {
        title: "macOS",
        desc: "Gateway 的菜单栏伴侣应用——通知、审批、快速聊天。",
      },
      windows: {
        title: "Windows",
      ...
      chrome: {
        title: "Chrome 扩展",
        desc: "让 OpenClaw 操控您现有的 Chrome——标签页、页面和表单。",
      },
      plugins: {
        title: "插件与 ClawHub",
        desc: "使用社区提供的渠道、工具和技能扩展 OpenClaw。",
      },
    },
  },
  profilePage: {
