...
export const pt_BR: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionsArchived: "{count} sessões arquivadas",
    deleteAllArchived: "Excluir todas as arquivadas…",
    deleteAllArchivedConfirm: "Excluir {count} sessões arquivadas e suas transcrições?",
    ...
    lastActive: "Última atividade {time}",
    surface: "Superfície",
    subject: "Assunto",
    room: "Sala",
    space: "Espaço",
  ...
  subtitles: {
    ...
    apps: "Apps complementares para telefone, relógio, desktop e navegador.",
    ...
    notifications: "Notificações push do navegador do seu gateway.",
  ...
  custodian: {
    ...
    placeholder: "Enviar mensagem ao OpenClaw…",
    sensitivePlaceholder: "Insira o valor sensível…",
  ...
  mcpServers: {
    ...
    nameInvalid: "Os nomes dos servidores usam letras, números, pontos, traços ou sublinhados.",
    targetInvalid: "Insira uma URL http(s) ou uma linha de comando.",
  ...
  sessionsPage: {
    hubTablistLabel: "Seções de sessões",
  },
  pluginsPage: {
  ...
  appsPage: {
    ...
    heroTagline:
      "Apps complementares para seu celular, relógio, desktop e navegador — além de plugins para ampliar o que seu agente pode fazer.",
    ...
    badgeBundledIos: "Incluído no app iOS",
    badgeBundledAndroid: "Incluído no app Android",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Converse, fale, aprove ações e compartilhe para o OpenClaw a partir do iOS.",
      },
      android: {
        title: "Android",
      ...
      macos: {
        title: "macOS",
        desc: "Companheiro na barra de menus para o seu Gateway — notificações, aprovações e conversas rápidas.",
      },
      windows: {
        title: "Windows",
        desc: "O aplicativo complementar para Windows conecta o seu PC como um nó do OpenClaw.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Deixe o OpenClaw controlar o seu Chrome existente — abas, páginas e formulários.",
      },
      plugins: {
  ...
  chat: {
    ...
    questions: {
      ...
      answered: "Respondido",
      answeredElsewhere: "Respondido em outro lugar",
      expired: "Expirado",
      cancelled: "Cancelado",
    },
    messages: {
    ...
    modelControls: {
      ...
      reasoning: "Raciocínio",
      speed: "Velocidade",
      sessionOverride: "Substituição de sessão",
