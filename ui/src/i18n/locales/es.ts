...
export const es: TranslationMap = {
  ...
  agentChip: {
    ...
    offlineOpenSettings: "Sin conexión: abre Ajustes",
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Los workers en la nube requieren el runtime de OpenClaw; {runtime} está seleccionado.",
  ...
  sessionsView: {
    ...
    sessionsArchived: "Se archivaron {count} sesiones",
    deleteAllArchived: "Eliminar todas las archivadas…",
    deleteAllArchivedConfirm: "¿Eliminar {count} sesiones archivadas y sus transcripciones?",
  ...
  custodian: {
    ...
    placeholder: "Escribe a OpenClaw…",
    sensitivePlaceholder: "Introduce un valor sensible…",
    ...
    connectionChanged:
      "La conexión con el Gateway cambió. Vuelve a intentarlo para continuar con esta configuración.",
  ...
  appsPage: {
    ...
    badgeBundledIos: "Incluido con la app de iOS",
    badgeBundledAndroid: "Incluido con la app de Android",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Chatea, habla, aprueba acciones y comparte en OpenClaw desde iOS.",
      },
      android: {
        title: "Android",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "La app complementaria de Android extiende OpenClaw a tu reloj.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "La app complementaria de Windows conecta tu PC como un nodo de OpenClaw.",
      },
      linux: {
        title: "Linux",
        desc: "App de escritorio nativa: compilaciones .deb y AppImage.",
      },
      chrome: {
  ...
  chat: {
    ...
    modelControls: {
      ...
      reasoning: "Razonamiento",
      speed: "Velocidad",
      sessionOverride: "Anulación de sesión",
    ...
    composer: {
      ...
      turnCameraOff: "Apagar la cámara",
      turnCameraOn: "Encender la cámara",
