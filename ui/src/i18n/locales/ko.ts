...
export const ko: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionsArchived: "{count}개의 세션을 보관함",
    deleteAllArchived: "보관된 항목 모두 삭제…",
    deleteAllArchivedConfirm: "보관된 세션 {count}개와 해당 대화 기록을 삭제하시겠습니까?",
  ...
  configView: {
    ...
    syncedHint: "게이트웨이를 통해 여러 기기에서 동기화됩니다.",
    notifications: {
      title: "푸시 알림",
  ...
  subtitles: {
    ...
    apps: "휴대폰, 워치, 데스크톱, 브라우저용 컴패니언 앱입니다.",
    ...
    advanced: "남은 모든 구성 섹션과 원본 파일 편집기입니다.",
    debug: "스냅샷, 이벤트, RPC.",
    logs: "실시간 Gateway 로그.",
  ...
  mcpServers: {
    ...
    nameTaken: "“{name}”(이)라는 이름의 MCP 서버가 이미 있습니다.",
    ...
    adminRequired: "MCP 서버 변경에는 operator.admin 액세스가 필요합니다.",
    enable: "활성화",
    disable: "비활성화",
    removeNamed: "{name} 제거",
    working: "작업 중…",
  ...
  appsPage: {
    heroTitle: "어디서나 OpenClaw 사용하기",
    heroTagline:
      "휴대폰, 시계, 데스크톱, 브라우저용 동반 앱과 에이전트의 기능을 확장하는 플러그인까지.",
    sectionMobile: "휴대폰에서",
    sectionWatch: "손목에서",
  ...
  chat: {
    ...
    questions: {
      ...
      timeRemaining: "남은 시간",
      ownAnswer: "직접 입력한 답변…",
      ownAnswerFor: "{header}에 대한 직접 입력 답변",
      submitting: "제출 중…",
      submitFailed: "제출할 수 없음: {error}",
      answered: "응답 완료",
