...
export const pl: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime:
      "Procesy robocze w chmurze wymagają środowiska OpenClaw; wybrano {runtime}.",
  ...
  sessionsView: {
    ...
    global: "Globalne",
    unknown: "Nieznane",
    sessionState: "Stan sesji",
    viewArchived: "Wyświetl zarchiwizowane",
    sessionArchived: "Sesja zarchiwizowana",
    sessionsArchived: "Zarchiwizowano {count} sesji",
    deleteAllArchived: "Usuń wszystkie zarchiwizowane…",
    deleteAllArchivedConfirm: "Usunąć {count} zarchiwizowanych sesji i ich transkrypcje?",
  ...
  configView: {
    ...
    syncedHint: "Synchronizowane między urządzeniami przez Gateway.",
    notifications: {
  ...
  subtitles: {
    ...
    custodian: "Konfiguracja i pielęgnacja systemu.",
    ...
    security: "Uwierzytelnianie Gateway, zasady wykonywania, profil narzędzi i zatwierdzenia.",
    advanced: "Wszystkie pozostałe sekcje konfiguracji oraz edytor pliku surowego.",
  ...
  custodian: {
    ...
    sensitivePlaceholder: "Wprowadź wartość poufną…",
    ...
    connectionChanged:
      "Połączenie z Gateway się zmieniło. Ponów próbę, aby kontynuować tę konfigurację.",
  ...
  appsPage: {
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Twój telefon z Androidem jako pełny węzeł OpenClaw — czat, kamera i Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
        desc: "Szybki podgląd czatów i błyskawiczne odpowiedzi z nadgarstka.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Aplikacja towarzysząca na pasku menu dla Twojego Gateway — powiadomienia, zatwierdzenia, szybki czat.",
      },
      windows: {
        title: "Windows",
      ...
      linux: {
        title: "Linux",
        desc: "Natywna aplikacja desktopowa — kompilacje .deb i AppImage.",
      },
      chrome: {
  ...
  chat: {
    ...
    modelControls: {
      ...
      reasoning: "Rozumowanie",
      speed: "Prędkość",
      sessionOverride: "Zastąpienie sesji",
      usingDefault: "Używanie ustawień domyślnych",
  ...
  cron: {
    ...
    form: {
      ...
      summaryEverySeconds: "Uruchamia się co {amount} s",
