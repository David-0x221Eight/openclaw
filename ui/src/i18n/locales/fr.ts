...
export const fr: TranslationMap = {
  ...
  sessionsView: {
    ...
    viewArchived: "Afficher les archives",
    sessionArchived: "Session archivée",
    sessionsArchived: "{count} sessions archivées",
    deleteAllArchived: "Supprimer toutes les archives…",
    deleteAllArchivedConfirm: "Supprimer {count} sessions archivées et leurs transcriptions ?",
  ...
  configView: {
    ...
    syncedHint: "Synchronisé sur vos appareils via le gateway.",
    notifications: {
  ...
  subtitles: {
    ...
    security: "Authentification du Gateway, politique d'exécution, profil d'outil et approbations.",
    advanced:
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "Votre guide de configuration système",
  ...
  mcpServers: {
    ...
    targetInvalid: "Saisissez une URL http(s) ou une ligne de commande.",
    ...
    adminRequired: "La modification des serveurs MCP nécessite un accès operator.admin.",
    enable: "Activer",
    disable: "Désactiver",
  ...
  sessionsPage: {
    hubTablistLabel: "Sections des sessions",
  },
  pluginsPage: {
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Discutez, parlez, approuvez des actions et partagez dans OpenClaw depuis iOS.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Aperçu des discussions et réponses rapides depuis votre poignet.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      macos: {
        title: "macOS",
        desc: "Compagnon dans la barre de menus pour votre Gateway — notifications, approbations, chat rapide.",
      },
      windows: {
        title: "Windows",
        desc: "Le compagnon Windows connecte votre PC comme nœud OpenClaw.",
      },
      linux: {
        title: "Linux",
  ...
  chat: {
    ...
    modelControls: {
      ...
      reasoning: "Raisonnement",
      speed: "Vitesse",
      sessionOverride: "Remplacement de session",
