...
export const zh_TW: TranslationMap = {
  ...
  newSession: {
    ...
    cloudRequiresOpenClawRuntime: "雲端工作者需要 OpenClaw runtime；目前已選擇 {runtime}。",
  ...
  sessionsView: {
    ...
    sessionsArchived: "已封存 {count} 個工作階段",
    deleteAllArchived: "刪除所有已封存…",
    deleteAllArchivedConfirm: "刪除 {count} 個已封存的工作階段及其記錄？",
  ...
  configView: {
    ...
    syncedHint: "透過 gateway 在您的裝置之間同步。",
    notifications: {
      title: "推播通知",
  ...
  mcpServers: {
    ...
    nameLabel: "名稱",
    targetLabel: "URL 或命令",
    nameInvalid: "伺服器名稱可使用字母、數字、點、破折號或底線。",
    targetInvalid: "請輸入 http(s) URL 或命令列。",
    nameTaken: "已存在名為「{name}」的 MCP 伺服器。",
    ...
    adminRequired: "MCP 伺服器變更需要 operator.admin 存取權。",
    enable: "啟用",
    disable: "停用",
    removeNamed: "移除 {name}",
    working: "處理中…",
  ...
  appsPage: {
    ...
    heroTagline: "適用於手機、手錶、桌面與瀏覽器的隨附應用程式，加上可擴充代理程式功能的外掛程式。",
    sectionMobile: "在手機上",
    sectionWatch: "在手腕上",
    sectionDesktop: "在桌面上",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "在 iOS 上聊天、通話、核准動作，並分享內容至 OpenClaw。",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "在手腕上一目了然地查看聊天並快速回覆。",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Android companion 將 OpenClaw 延伸到你的手錶。",
      },
      macos: {
        title: "macOS",
        desc: "你的 Gateway 的選單列 companion — 通知、核准、快速聊天。",
      },
      windows: {
        title: "Windows",
        desc: "Windows companion 將你的 PC 連接為 OpenClaw 節點。",
      },
      linux: {
        title: "Linux",
      ...
      plugins: {
        title: "外掛與 ClawHub",
        desc: "透過社群提供的頻道、工具與 Skills 擴充 OpenClaw。",
      },
    },
  },
  profilePage: {
