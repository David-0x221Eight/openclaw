...
export const ru: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionsArchived: "Архивировано сессий: {count}",
    deleteAllArchived: "Удалить весь архив…",
    deleteAllArchivedConfirm: "Удалить {count} архивированных сессий и их транскрипты?",
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "Ваш гид по настройке системы",
    ...
    connectionChanged:
      "Соединение с Gateway изменилось. Повторите попытку, чтобы продолжить эту настройку.",
  ...
  mcpServers: {
    ...
    nameInvalid: "В именах серверов допускаются буквы, цифры, точки, дефисы и подчёркивания.",
    targetInvalid: "Введите http(s) URL или командную строку.",
    ...
    configUnavailable: "Конфигурация недоступна; обновите и попробуйте снова.",
  ...
  sessionsPage: {
    hubTablistLabel: "Разделы сессий",
  },
  pluginsPage: {
  ...
  appsPage: {
    heroTitle: "Берите OpenClaw с собой везде",
    heroTagline:
      "Приложения-компаньоны для телефона, часов, компьютера и браузера — плюс плагины, расширяющие возможности вашего агента.",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Беглый просмотр чатов и быстрые ответы с запястья.",
      },
      wearOs: {
        title: "Wear OS",
        desc: "Приложение-компаньон для Android расширяет OpenClaw на ваши часы.",
      },
      macos: {
        title: "macOS",
        desc: "Помощник в строке меню для вашего Gateway — уведомления, подтверждения, быстрый чат.",
      },
      windows: {
        title: "Windows",
        desc: "Помощник для Windows подключает ваш ПК как узел OpenClaw.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Позвольте OpenClaw управлять вашим Chrome — вкладки, страницы и формы.",
      },
      plugins: {
  ...
  chat: {
    ...
    modelControls: {
      ...
      reasoning: "Рассуждение",
      speed: "Скорость",
      sessionOverride: "Переопределение сессии",
