...
export const uk: TranslationMap = {
  ...
  sessionsView: {
    ...
    sessionArchived: "Сесію архівовано",
    sessionsArchived: "Архівовано {count} сесій",
    deleteAllArchived: "Видалити всі архівовані…",
    deleteAllArchivedConfirm: "Видалити {count} архівованих сесій та їхні транскрипти?",
  ...
  subtitles: {
    ...
    apps: "Супутні застосунки для телефона, годинника, комп'ютера та браузера.",
  ...
  mcpServers: {
    ...
    nameInvalid: "У назвах серверів використовуйте літери, цифри, крапки, тире або підкреслення.",
    targetInvalid: "Введіть http(s) URL або командний рядок.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Супутні застосунки для вашого телефона, годинника, комп'ютера та браузера — а також плагіни, щоб розширити можливості вашого агента.",
    ...
    ctaSetupGuide: "Посібник з налаштування",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Спілкуйтеся в чаті, говоріть, підтверджуйте дії та діліться в OpenClaw з iOS.",
      },
      android: {
        title: "Android",
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Швидкий перегляд чатів і відповіді просто із зап'ястя.",
      },
      wearOs: {
        title: "Wear OS",
      ...
      linux: {
        title: "Linux",
        desc: "Нативний застосунок для стільниці — збірки .deb та AppImage.",
      },
      chrome: {
        title: "Розширення Chrome",
        desc: "Дозвольте OpenClaw керувати вашим наявним Chrome — вкладки, сторінки та форми.",
      },
      plugins: {
        title: "Плагіни та ClawHub",
        desc: "Розширюйте OpenClaw каналами, інструментами та Skills від спільноти.",
      },
    },
  },
  profilePage: {
  ...
  chat: {
    ...
    questions: {
      ...
      answered: "Відповідь отримано",
      answeredElsewhere: "Відповіли в іншому місці",
      expired: "Застарів",
      cancelled: "Скасовано",
    },
    messages: {
    ...
    modelControls: {
      ...
      reasoning: "Міркування",
      speed: "Швидкість",
      sessionOverride: "Перевизначення сеансу",
